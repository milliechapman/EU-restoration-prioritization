...
pu_cropland_low_budget_data <- read_csv("data-formatted/linear_constraints/pu_crop_low_budget_data_ref.csv")
...
pu_cropland_med_budget_data <- read_csv("data-formatted/linear_constraints/pu_crop_med_budget_data_ref.csv")
...
pu_cropland_high_budget_data <- read_csv("data-formatted/linear_constraints/pu_crop_high_budget_data_ref.csv")
...
pu_pasture_high_budget_data <- read_csv("data-formatted/linear_constraints/pu_pasture_high_budget_data_ref.csv")
...
pu_pasture_low_budget_data <- read_csv("data-formatted/linear_constraints/pu_pasture_low_budget_data_ref.csv")

nuts2_forest_multi <- read_csv("data-formatted/linear_constraints/nuts_forest_multi_ref_adjusted.csv")
pu_forest_multi_budget_data <- read_csv("data-formatted/linear_constraints/pu_forest_multi_budget_data_ref.csv")

nuts2_forest_prod <- read_csv("data-formatted/linear_constraints/nuts_forest_prod_ref_adjusted.csv")
pu_forest_prod_budget_data <- read_csv("data-formatted/linear_constraints/pu_forest_prod_budget_data_ref.csv")

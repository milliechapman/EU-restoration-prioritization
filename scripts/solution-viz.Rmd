...
```{r}
sol <- "../data/solutions/sol/SI-sol/sol_carbon_0.5_restoration_0.141_production_NA_country_FLEX_wetlands_TRUE_onlyrestoration_TRUE_scenario_Baseline_onlyRest_gurobi_f455.csv"

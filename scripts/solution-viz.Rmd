...
```{r}
sol <- "../data/solutions/sol/NUTSadj/sol_carbon_0.9_restoration_0.141_production_NUTS2adj_country_EVEN_wetlands_TRUE_onlyrestoration_FALSE_scenario_Baseline_proportional_gurobi_f455.csv"
